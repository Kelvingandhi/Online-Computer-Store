...
<form action="" method="POST">
	...
	<div class="container" style="width: 65%; margin-top:3em;">
		...
		<?php
            ...
            $query = "SELECT PID,COUNT(PID) AS X FROM cart JOIN apperars_in ON cart.cartid=apperars_in.cartid WHERE TDATE >= '$start_date' AND TDATE <= '$end_date' group by PID HAVING COUNT(PID)>2 ORDER BY COUNT(PID) DESC";
