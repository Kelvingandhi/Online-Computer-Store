...
<body>
	...
	<div class="container" style="width: 65%; margin-top:3em;">
		...
		<?php
            ...
            $query = "SELECT C.CID, SUM(A.PRICESOLD*A.QUANTITY) AS TOTAL_SPENT FROM CART C, APPERARS_IN A WHERE C.CARTID = A.CARTID AND C.TDATE BETWEEN '$start_date' AND '$end_date' GROUP BY C.CID ORDER BY SUM(A.PRICESOLD*A.QUANTITY) DESC LIMIT 10";
