...
<body>
	...
	<div class="container" style="width: 65%; margin-top:3em;">
		...
		<?php
            ...
            $query = "SELECT  P.PNAME,COUNT(DISTINCT C.CID) FROM CART C, APPERARS_IN A, PRODUCT P WHERE C.CARTID = A.CARTID AND C.TDATE BETWEEN '$start_date' AND '$end_date' AND A.PID = P.PID GROUP BY A.PID ORDER BY COUNT(DISTINCT C.CID) DESC";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                    	...
                    	<tr>
                    		...
                    		<td><?php echo($row['COUNT(DISTINCT C.CID)']) ?></td>
                    	</tr>
